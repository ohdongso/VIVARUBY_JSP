            ...
            <div class="product_top_bar" align="center">   
              ...
              <div class="left_dorp">
              	...
              	<div align="center">     	
   				...
   				<a href="${path}/front?key=product&methodName=selectProductCapacity&category=5&min=30&max=49">30ml~49ml</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               
              	<a href="${path}/front?key=product&methodName=selectProductCapacity&category=5&min=50&max=79">50ml~79ml</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				
				<a href="${path}/front?key=product&methodName=selectProductCapacity&category=5&min=80&max=100">80ml~100ml</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				
              	<a href="${path}/front?key=product&methodName=selectNewProduct&category=5">신상품</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	
           	    <a href="${path}/front?key=product&methodName=selectProductName&category=5">상품명</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	             	    
           	    <a href="${path}/front?key=product&methodName=selectQtySell&category=5">인기순</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           	    
           	    <a href="${path}/front?key=product&methodName=selectMinPrice&category=5">낮은가격</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
           	    
           	    <a href="${path}/front?key=product&methodName=selectMaxPrice&category=5">높은가격</a>
              	</div>             	
              </div>
            </div>              
            ...
            <div class="left_sidebar_area">
              <aside class="left_widgets p_filter_widgets">
                ...
                <div class="widgets_inner">
                  <ul class="list">
                    <li>
                      <a href="${path}/front?key=product&methodName=selectProCategory&category=5">선물세트</a>
                    </li>
                  </ul>
                </div>
              </aside>         
