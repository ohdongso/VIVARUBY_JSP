          ...
          <div class="col-lg-9">     
            <div class="latest_product_inner">
              <div class="row">
			   ...
			   <!--  들어가는 위치 -->
<%-- 			   ${faqList} --%>
				<form action="${path}/front?key=faq&methodName=updateFaq" method="post" style="width: 100%;">
			   	<table border="1">
					<tr style="height: 30px;">
						<td>
							<input type="text" name="title" placeholder="제목" style="height: 30px;" value="${faqDTO.fTitle}">
						</td>
					</tr>
					...
					<tr style="height: 200px;">
						<td>
							...
							style="height: 250px;">${faqDTO.fContent}</textarea>
						</td>
					</tr>
					...
					<tr style="height: 30px;">
						<td>
								...
								<input type="hidden" name="fCode" value="${faqDTO.fCode}">
						</td>
					</tr>
				</table>		
				</form>
